...
owner1 = "OWK"
owner2 = "Andy"
ScriptVersion = "(Leon modificat By OWK)"
...
-----!!!! IMPORTANT Setting !!!!-----
--------------------------------------------------------------------------------
locdef1 = "/etc/verlihub" -- locul unde este creat folderul hubului ( /etc/verlihub sau /root/.verlihub sau /home/.verlihub, etc )
--------------------------------------------------------------------------------
...
---------------[ Script entry point ]---------------
res, err = VH:AddRobot(BotName2, 10, "OWK-Bot", " mofturoasa ", " fitzoasa  Sexy si Rea", "0")
res, err = VH:AddRobot(BotName1, 10, "OWK-Bot", " langa ea  ", "  Love Eve !!! ", "0")
res, err = VH:AddRobot(BotName3, 10, "OWK-Bot", " helper  ", "  Love Eve !!! ", "0")
loadQZ()
ReloadQuestions()
LoadScores()
loadmarimi()
